...
// 开启缓存 记得在ehcache_hibernate.xml配置
public class User implements Serializable {
	 ...
	 * public String getFormat_user_approvaltime() { SimpleDateFormat formater =
	 * new SimpleDateFormat("yyyy-MM-dd HH:mm:ss"); return
	 * formater.format(user_approvaltime); }
	 */
	...
	/*
	 * public String getFormat_user_registertimes() { SimpleDateFormat formater
	 * = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss"); return
	 * formater.format(user_registertime); }
	 */
