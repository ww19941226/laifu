...
//	            iconCls: scope.langIconCls,
	        	icon : basePath+'/js/ext/icons/image_add.png',
	            tooltip: {
	                ...
	                items: [{
	                    ...
	                    items: [{
	                        ...
	                        buttons: [{
	                            text: '保存',
	                            action: 'btn_save',
	                            icon: basePath+'/js/ext/icons/disk.png',
	                            handler: function (btn) {
	                                scope.saveUploadImg(btn, view);
	                            }
	                        }, {
	                            text: '取消',
	                            icon:  basePath+'/js/ext/icons/cross.png',
	                            handler: function (btn) {
	                                btn.up('window').close();
	                            }
	                        }]
	            ...
	            formObj.form.doAction('submit', {
	                ...
	                success: function (response, options) {
	                    ...
	                    if(result.returnResult!=200){
	                    	Ext.MessageBox.alert('温馨提示', result.returnDetail);
	                        return;
	                    }
	                    scope.insertImg(view, result.returnData);
