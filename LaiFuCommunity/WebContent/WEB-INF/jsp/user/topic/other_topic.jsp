...
<div class="content">
    <!--头像和话题分类-->
    <div class="my_fenlei">
        <img src="<c:url value='<%=((User)request.getAttribute("author")).getUser_head()%>'/>"">
        <span><%=((User)request.getAttribute("author")).getUser_nickname()%>的话题</span>
        <!-- <div class="fenlei">
...
<script>
    $(document).ready(function () {
    	...
    	/* 当前用户的头像路径 */
    	var user_head='<%=((User)request.getAttribute("author")).getUser_head()%>';
    	console.log("当前用户的头像路径"+user_head);
    	/* 当前用户的用户id */
    	var user_id='<%=((User)request.getAttribute("author")).getUser_id()%>';
    	console.log("当前用户的用户id"+user_id);
    	/* 当前用户的昵称 */
    	var user_nickname='<%=((User)request.getAttribute("author")).getUser_nickname()%>';
