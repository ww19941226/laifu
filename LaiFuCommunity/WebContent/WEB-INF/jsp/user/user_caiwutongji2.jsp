...
<html>
    ...
    <body>
    <div style="text-align:center;margin-bottom: 80px;"><h1 style="margin-right: auto;margin-left: auto;">费用百分比</h2></div>
        <div id="chartpdiv" style="width:750px; height:700px;"></div>
    </body>
