...
<head>
   ...
   function submitInforAction() {
    ...
    $.ajaxFileUpload({  
        //处理文件上传操作的服务器端地址 
        url:"${pageContext.request.contextPath}/sysadmin/uploadPicture",  
...
<div class="pro-info-content clearfix">
    <div class="info-left fl">
        ...
        <div class="info-edit"><a href="<c:url value='/sysadmin/information/password_update' />">修改密码</a></div>
    </div>
    <div class="info-right fl">
        <div class="info-rows">
            <h1>基本资料</h1>
            <form id="inforForm" action="<c:url value='/sysadmin/updateInfor' />" method="post">
            <div class="info-row">
            ...
            <div class="info-row">
                <div class="clearfix">
                    <span>昵称:</span>
                    <input type="text" name="user_nickname" value='${ sessionScope["admin"].user.user_nickname }' />
                </div>
            </div>
            <div class="info-row">
                <div class="clearfix">
