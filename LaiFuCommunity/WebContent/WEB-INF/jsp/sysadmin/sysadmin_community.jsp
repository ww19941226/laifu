...
<div class="pro-complains-content clearfix">
    <div class="complains-box">
        ...
        <table>
            ...
            <tr>
                ...
                <td><a href="<c:url value='/sysadmin/${ c.community_id }/community/community_detail' />">查看详情</a></td>
                <td><a href="<c:url value='/sysadmin/${ c.community_id }/community/community_edit' />">修改</a><a href="<c:url value='/sysadmin/${ c.community_id }/deleteCommunity' />" onclick="return validator()">删除</a><a href="<c:url value='/sysadmin/${c.community_id}/checkcomm/checkcomm_detail' />">进入审核</a></td>
            </tr>
            </c:forEach>
        </table>
    ...
    <div class="page complains-page">
    	<common:pageV3 url="/sysadmin/sysadmin_community" optimize="true"/>
