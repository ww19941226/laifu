...
<script src="../js/jquery-1.11.1.min.js"></script>
    ...
    <body>
   	 	<div style="text-align:center;"><h1 style="margin-right: auto;margin-left: auto;">年度缴费统计</h2></div>
        <div id="chartdiv" style="width: 900px; height: 500px;margin-right:auto;margin-left:auto;"></div>
    </body>
