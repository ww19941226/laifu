...
<div class="pro-info-content clearfix">
    <div class="password-content">
        ...
        <div class="new-pwd-box detail-box">
            ...
            <div class="new-pwd">
                <!-- <a class="new-notify-btn" href="<c:url value='/comadmin/user/${user.user_id}/user_edit' />" >修改</a>-->
                <c:if test="${ user.user_checkstate == 0 }">
                	 <a class="new-notify-btn" href="<c:url value='/comadmin/user/${user.user_id}/1/usercheck' />" onclick="return validator()">通过</a><a class="new-notify-btn" href="<c:url value='/comadmin/user/${user.user_id}/2/usercheck' />"  onclick="return validator()">不通过</a>
                </c:if>
            </div>
        </div>
        <h1>莱福欢迎您！</h1>
